...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        lbl_answer->setGeometry(QRect(0, 70, 201, 61));
        QFont font4;
        font4.setPointSize(11);
        lbl_answer->setFont(font4);
        lbl_answer->setStyleSheet(QString::fromUtf8("background-color: qconicalgradient(cx:0, cy:0,angle:0 ,stop:0 rgba(0, 0, 0, 0));"));
