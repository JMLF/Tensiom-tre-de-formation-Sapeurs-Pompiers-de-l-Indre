...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_close->setGeometry(QRect(10, 20, 80, 80));
        QFont font;
        ...
        btn_close_2->setGeometry(QRect(10, 20, 80, 80));
        QFont font5;
        font5.setPointSize(26);
        btn_close_2->setFont(font5);
        btn_close_2->setStyleSheet(QString::fromUtf8("background-color: rgb(208, 0, 0);"));
        ...
        btn_close_3->setGeometry(QRect(10, 20, 80, 80));
        btn_close_3->setFont(font5);
        btn_close_3->setStyleSheet(QString::fromUtf8("background-color: rgb(208, 0, 0);"));
        ...
        lbl_answer_trame->setFont(font6);
        ...
        lbl_answer_server->setFont(font6);
        ...
        gBox_settings->setGeometry(QRect(1470, 0, 480, 800));
        ...
        btn_close_4->setGeometry(QRect(10, 20, 80, 80));
        btn_close_4->setFont(font5);
        btn_close_4->setStyleSheet(QString::fromUtf8("background-color: rgb(208, 0, 0);"));
        btn_confirm = new QPushButton(gBox_settings);
        btn_confirm->setObjectName(QString::fromUtf8("btn_confirm"));
        btn_confirm->setGeometry(QRect(300, 180, 150, 90));
        QFont font7;
        font7.setPointSize(14);
        btn_confirm->setFont(font7);
        ...
        btn_cancel->setGeometry(QRect(70, 180, 150, 90));
        btn_cancel->setFont(font7);
        ...
        lbl_new_pin->setGeometry(QRect(140, 70, 241, 31));
        lbl_new_pin->setFont(font6);
        ...
        line_edit_pin->setGeometry(QRect(210, 110, 91, 51));
        ...
        lbl_waiting->setGeometry(QRect(8, 120, 471, 441));
        lbl_waiting->setFont(font5);
        ...
        btn_confirm_security->setGeometry(QRect(170, 210, 150, 90));
        btn_confirm_security->setFont(font7);
        ...
        line_edit_pin_security->setGeometry(QRect(190, 100, 111, 51));
        line_edit_pin_security->setFont(font1);
        ...
        label->setGeometry(QRect(220, 50, 71, 31));
        label->setFont(font5);
        ...
        lbl_pop_up->setGeometry(QRect(10, 90, 471, 501));
        lbl_pop_up->setFont(font5);
        ...
        QObject::connect(btn_close_5, SIGNAL(clicked()), MainWindow, SLOT(close()));
