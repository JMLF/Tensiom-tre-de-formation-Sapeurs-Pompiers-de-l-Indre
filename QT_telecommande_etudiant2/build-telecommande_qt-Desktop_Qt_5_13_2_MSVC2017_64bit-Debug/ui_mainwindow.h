...
public:
    ...
    void setupUi(QMainWindow *MainWindow)
    {
        ...
        btn_ok->setGeometry(QRect(370, 670, 100, 100));
        btn_ok->setFont(font);
        ...
        btn_2->setGeometry(QRect(250, 370, 100, 100));
        btn_2->setFont(font);
        ...
        lbl_dia->setGeometry(QRect(210, 440, 120, 120));
        ...
        lbl_pul->setGeometry(QRect(210, 270, 120, 120));
        ...
        btn_confirm->setGeometry(QRect(180, 520, 150, 90));
        QFont font7;
        ...
        btn_cancel->setGeometry(QRect(180, 640, 150, 90));
        ...
        lbl_old_pin->setGeometry(QRect(140, 75, 201, 41));
        lbl_old_pin->setFont(font6);
        ...
        spinBox_old_pin1->setGeometry(QRect(10, 150, 120, 90));
        QFont font8;
        font8.setPointSize(48);
        spinBox_old_pin1->setFont(font8);
        ...
        spinBox_old_pin2->setGeometry(QRect(180, 150, 120, 90));
        spinBox_old_pin2->setFont(font8);
        ...
        spinBox_old_pin3->setGeometry(QRect(350, 150, 120, 90));
        spinBox_old_pin3->setFont(font8);
        ...
        spinBox_new_pin3->setGeometry(QRect(350, 320, 120, 90));
        spinBox_new_pin3->setFont(font8);
        ...
        spinBox_new_pin2->setGeometry(QRect(180, 320, 120, 90));
        spinBox_new_pin2->setFont(font8);
        ...
        lbl_new_pin->setGeometry(QRect(150, 260, 241, 31));
        ...
        spinBox_new_pin1->setGeometry(QRect(10, 320, 120, 90));
        spinBox_new_pin1->setFont(font8);
        ...
        lbl_pin->setGeometry(QRect(130, 440, 301, 51));
        lbl_pin->setFont(font6);
        ...
        spinBox_3->setGeometry(QRect(170, 390, 200, 150));
        spinBox_3->setFont(font9);
        ...
        btn_confirm_security->setGeometry(QRect(180, 680, 150, 90));
        ...
        lbl_pin_security->setGeometry(QRect(180, 560, 190, 80));
        ...
        scrollArea = new QScrollArea(gBox_security);
        scrollArea->setObjectName(QString::fromUtf8("scrollArea"));
        scrollArea->setGeometry(QRect(0, 590, 120, 80));
